...
contract TakeTest is BaseTest {
    ...
    function testWithdrawSecondaryWithLender() public {
        ...
        terms.take(term, 0, 101, 0, lender, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithBorrower() public {
        ...
        lendOffer.nonce = 1;
        terms.take(term, 0, 101, 0, lender, lendOffer, sig(lendOffer, borrowerSK), address(0), hex"");
    ...
    function testMatch() public {
        ...
        terms.take(term, 0, 101, 0, address(this), lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
