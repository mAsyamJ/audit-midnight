...
contract TakeTest is BaseTest {
    ...
    function setUp() public override {
        ...
        lendOffer.end = block.timestamp + 200;
        lendOffer.startPrice = 0.99 ether;
        lendOffer.endPrice = 0.99 ether;
        lendOffer.nonce = 0;
        ...
        borrowOffer.end = block.timestamp + 200;
        borrowOffer.startPrice = 0.99 ether;
        borrowOffer.endPrice = 0.99 ether;
        borrowOffer.nonce = 0;
    ...
    function testWithdrawSecondaryWithLender() public {
        ...
        terms.take(term, 100, 0, lender, lendOffer, sig(lendOffer, otherLenderSK), address(0), hex"");
    ...
    function testWithdrawSecondaryWithBorrower() public {
        ...
        lendOffer.nonce = 1;
        terms.take(term, 100, 0, lender, lendOffer, sig(lendOffer, borrowerSK), address(0), hex"");
    ...
    function testMatch() public {
        ...
        terms.take(term, 100, 0, address(this), lendOffer, sig(lendOffer, lenderSK), address(0), hex"");
    ...
    function testTakeOCO() public {
        ...
        lendOffer2.end = block.timestamp + 200;
