...
contract MorphoV2 is IMorphoV2 {
    ...
    bytes32 public constant OFFER_TYPEHASH = keccak256(
        "Offer(bool lend,address offeror,uint256 assets,address loanToken,Collateral[] collaterals,uint256 maturity,uint256 start,uint256 expiry,uint256 startPrice,uint256 expiryPrice,uint256 nonce)"
    );
    ...
    function take(
        ...
        (
            ...
            ? (offer.offeror, offer.callbackAddress, offer.callbackData, taker, takerCallbackAddress, takerCallbackData)
            : (taker, takerCallbackAddress, takerCallbackData, offer.offeror, offer.callbackAddress, offer.callbackData);
        ...
        require((consumed[offer.offeror][offer.nonce] += assets) <= offer.assets, "consumed");
    ...
    function signatureIsValid(Offer memory offer, Signature memory signature) internal view returns (bool) {
        ...
        return signatory != address(0) && offer.offeror == signatory;
    }
