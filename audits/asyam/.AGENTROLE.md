...
7. [workflow/protocolIntent/README.md](workflow/protocolIntent/README.md) — economic model + invariants (**read before PoC hunting**)
   - Then: [00_PROTOCOL_INTENTION_SUMMARY.md](workflow/protocolIntent/00_PROTOCOL_INTENTION_SUMMARY.md), [12_SECURITY_RELEVANT_INVARIANTS.md](workflow/protocolIntent/12_SECURITY_RELEVANT_INVARIANTS.md), [14_PROTOCOL_INTENT_TO_POC_TARGETS.md](workflow/protocolIntent/14_PROTOCOL_INTENT_TO_POC_TARGETS.md)
8. [workflow/attackPlan/README.md](workflow/attackPlan/README.md) — exploit plan from `src/*` + `test/*` (**before implementing new PoCs**)
   - Then: [06_HIGH_VALUE_POC_QUEUE.md](workflow/attackPlan/06_HIGH_VALUE_POC_QUEUE.md), [09_DISPROOF_AND_FALSE_POSITIVE_FILTER.md](workflow/attackPlan/09_DISPROOF_AND_FALSE_POSITIVE_FILTER.md), [10_EXECUTION_PLAN.md](workflow/attackPlan/10_EXECUTION_PLAN.md)
9. [MIDNIGHT_AGENTIC_SECURITY_MAP.md](MIDNIGHT_AGENTIC_SECURITY_MAP.md) — architecture graph
10. [InfoCantinaPoCRules.md](InfoCantinaPoCRules.md) — Cantina submission format
...
| Protocol intent | [workflow/protocolIntent/README.md](workflow/protocolIntent/README.md) | Economic model, invariants, PoC targets (pre-PoC) |
| Attack plan | [workflow/attackPlan/README.md](workflow/attackPlan/README.md) | Function surfaces, AP-XXX PoC queue, disproof filter |
...
Proven (Cantina-ready):
  ...
  P3-02 — CVL summaries alias production-distinct market IDs (formal-assurance gap)
...
Expected baseline (2026-05-30): full suite 407 tests; harness 20/20; asyamFindings 14/14.
